...
contract("BreezySwapV1BREWETH", (accounts) => {
    ...
    beforeEach(async () => {
        ...
        const initialBaseLiquidity = web3.utils.toBN('100000000').mul(web3.utils.toBN(10 ** baseDecimals)); // Scaled to baseDecimals
        const initialTradeLiquidity = web3.utils.toBN('100000000').mul(web3.utils.toBN(10 ** tradeDecimals)); // Scaled to tradeDecimals
        ...
        const baseInputAmountForLP = web3.utils.toBN('10000000').mul(web3.utils.toBN(10 ** baseDecimals)); // Scaled to baseDecimals
        const maxTokenInputAmountForLP = web3.utils.toBN('9000000').mul(web3.utils.toBN(10 ** tradeDecimals)); // Scaled to tradeDecimals
    ...
    it("should correctly calculate token output from base input", async () => {
        ...
        const baseInputAmount = web3.utils.toBN('31415926').mul(web3.utils.toBN(10 ** baseDecimals));
    ...
    it("should correctly calculate LP tokens when adding liquidity", async () => {
        ...
        const baseLiquidityAmount = web3.utils.toBN('314159').mul(web3.utils.toBN(10 ** baseDecimals));
        const tradeLiquidityAmount = web3.utils.toBN('314159').mul(web3.utils.toBN(10 ** tradeDecimals));
    ...
    it("should maintain the reserve ratio when adding liquidity", async () => {
        // Generate a random floating-point value between 1 and 10000000, with one decimal point
        const randomBaseInput = (Math.random() * 9999999 + 1).toFixed(baseDecimals);
    ...
    it("should correctly handle swapBaseToTokenWithBaseInput", async () => {
        // Generate a random floating-point value between 1 and 10000000, with base decimal point
        const randomBaseInput = (Math.random() * 9999999 + 1).toFixed(baseDecimals);
    ...
    it("should correctly handle swapTokenToBaseWithTokenInput", async () => {
        // Generate a random floating-point value between 1 and 10000000, with token decimal point
        const randomTokenInput = (Math.random() * 9999999 + 1).toFixed(tradeDecimals);
    ...
    it("should use entire balance when attempting to swap with higher input amount swapBaseToTokenWithBaseInput", async () => {
        ...
        const baseInputAmount = web3.utils.toBN('100000001').mul(web3.utils.toBN(10 ** baseDecimals)); // 100 base tokens
    ...
    it("should use entire balance when attempting to swap trade tokens with higher input amount swapTokenToBaseWithTokenInput", async () => {
        ...
        const tokenInputAmount = web3.utils.toBN('100000001').mul(web3.utils.toBN(10 ** tradeDecimals)); // 100 trade tokens
